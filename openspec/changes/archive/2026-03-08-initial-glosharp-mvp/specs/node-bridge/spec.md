...
The package SHALL export TypeScript interfaces for `GloSharpResult`, `GloSharpHover`, `GloSharpError`, `GloSharpMeta`, and `GloSharpDisplayPart` matching the JSON output schema.
